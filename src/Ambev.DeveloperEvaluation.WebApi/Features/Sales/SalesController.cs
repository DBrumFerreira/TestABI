...
public class SalesController : BaseController
{
    ...
    public async Task<IActionResult> CreateAsync([FromBody] CreateSaleRequest request, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> UpdateAsync([FromBody] UpdateSaleRequest request, CancellationToken cancellationToken)
    {
